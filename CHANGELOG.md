...
## [1.19.0](https://github.com/misty-step/volume/compare/v1.18.0...v1.19.0) (2026-04-23)


### Features

* **api:** add domain action contract ([#481](https://github.com/misty-step/volume/issues/481)) ([6718dba](https://github.com/misty-step/volume/commit/6718dbafb78df7eb4ff3f45123c1e8acda4bd399))
...
* **coach:** render authenticated workspace at root ([947e330](https://github.com/misty-step/volume/commit/947e330bec30420410b808782d553ecc54d99554))
* **coach:** render authenticated workspace at root ([947e330](https://github.com/misty-step/volume/commit/947e330bec30420410b808782d553ecc54d99554))
...
* make coach the default route and migrate observability to Canary ([#478](https://github.com/misty-step/volume/issues/478)) ([62b78af](https://github.com/misty-step/volume/commit/62b78af6faf6a37b5531ecf9fd720da49f8dd661))
...
* **harness:** install ship skill locally ([#480](https://github.com/misty-step/volume/issues/480)) ([032878e](https://github.com/misty-step/volume/commit/032878ea0be73e320ffc8fb98f86b2677d665331))
...
* canonicalize openrouter runtime policy ([#422](https://github.com/misty-step/volume/issues/422)) ([dd6d578](https://github.com/misty-step/volume/commit/dd6d57800c96b8f404f75b345066a5a729ac7c79))
...
* remove deterministic coach fallback parser ([#405](https://github.com/misty-step/volume/issues/405)) ([7065ddc](https://github.com/misty-step/volume/commit/7065ddc7cf536b9265109bde73abfacbbc590522))
...
* 3b design system + agentic chat overhaul (coach tools, generative UI, test coverage) ([#378](https://github.com/misty-step/volume/issues/378)) ([df41cce](https://github.com/misty-step/volume/commit/df41cce6aa01fbf58f75470148837aada268dd6f))

## [1.13.0](https://github.com/misty-step/volume/compare/v1.12.1...v1.13.0) (2026-02-28)


### Features

* **analytics:** wire PostHog events and Sentry user context ([#381](https://github.com/misty-step/volume/issues/381)) ([753bea5](https://github.com/misty-step/volume/commit/753bea58c539fde59511093295e1c6436259a299))
* **quality:** CI coverage gate + ESLint rule enforcement ([#380](https://github.com/misty-step/volume/issues/380)) ([d4c472c](https://github.com/misty-step/volume/commit/d4c472c4cdcb22a376c31058bcc08d21eea71256))
...
* migrate from pnpm to Bun ([#355](https://github.com/misty-step/volume/issues/355)) ([926e338](https://github.com/misty-step/volume/commit/926e338f0b518c4f17dd7f923094a90203b9e0db))
...
* resolve Sentry production issues VOLUME-1, VOLUME-2, VOLUME-4 ([#320](https://github.com/misty-step/volume/issues/320)) ([5b000ec](https://github.com/misty-step/volume/commit/5b000ec9e3cc3e99569abbb96182f50babc1c1de))

## [1.9.0](https://github.com/misty-step/volume/compare/v1.8.0...v1.9.0) (2026-02-01)


### Features

* user preferences for AI coaching ([#312](https://github.com/misty-step/volume/issues/312)) ([aec6eec](https://github.com/misty-step/volume/commit/aec6eec0ff885821ee02dd00b79fc6ccdc95dcd7))
